...
public class DlgRectangle extends JDialog {
	...
	public DlgRectangle() {
		...
		getContentPane().setLayout(gridBagLayout);
		{
			...
			gbl_contentPanel.columnWidths = new int[]{1, 81, 83, 93, 0};
			gbl_contentPanel.rowHeights = new int[]{19, 19, 19, 19, 19, 23, 0, 0};
		...
		}
		{
			...
			buttonPane.setBackground(new Color(153, 50, 204));
